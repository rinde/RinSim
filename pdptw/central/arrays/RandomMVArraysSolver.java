        ...
        for (int i = 0; i < v; i++) {
            ...
            for (int j = 1; j < route.length; j++) {
                ...
                final int earliestArrivalTime =
                        arrivalTimes[j - 1] + serviceTimes[prev] + tt;
            ...
            final int totalTravelTime =
                    ArraysSolvers.computeTotalTravelTime(route, travelTime,
                        vehicleTravelTimes[i]);
            final int tardiness =
                    ArraysSolvers.computeSumTardiness(route, arrivalTimes,
                        serviceTimes, dueDates);
            sols[i] =
                    new SolutionObject(route, arrivalTimes, totalTravelTime
                            + tardiness);
