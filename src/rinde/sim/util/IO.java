...
public class IO {
	...
	public static void serialize(final Serializable o, final String file) {
		try {
			final ObjectOutputStream s = new ObjectOutputStream(new GZIPOutputStream(new BufferedOutputStream(new FileOutputStream(file))));
			s.writeObject(o);
			s.close();
	...
	public static <T extends Serializable> T deserialize(final String file, Class<T> type) {
	...
	public static Object deserialize(final String file) {
		try {
			final ObjectInputStream s = new ObjectInputStream(new GZIPInputStream(new BufferedInputStream(new FileInputStream(file))));
