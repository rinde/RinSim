...
public interface CommunicationAPI {
	/**
	 * Send the message to a given recipient. Message will be delivered with a specific probability if recipient is 
	 * within the range (see {@link CommunicationUser} for details). 
	 * @param recipient
	 * @param message
	 */
	...
	/**
	 * Send the message to a given recipient. Message will be delivered with a specific probability to all possible recipients
	 * within the range (see {@link CommunicationUser} for details). 
	 * @param recipient
	 * @param message
	 */
