...
public class ScenarioBuilderTest {
  ...
  public void addMultipleEvents() {
    ...
    assertEquals(
        asList(new TimedEvent(EVENT_A, 0), new TimedEvent(EVENT_A,
            0), new TimedEvent(EVENT_A, 100), new TimedEvent(EVENT_A, 100),
            new TimedEvent(
  ...
  public void addTimeSeriesOfEvents() {
    ...
    assertEquals(asList(new TimedEvent(EVENT_A, 0), new TimedEvent(EVENT_A,
        1), new TimedEvent(EVENT_A, 2), new TimedEvent(EVENT_A, 3)),
        scenarioBuilder
            .build().asList());
    ...
    assertEquals(
        asList(new TimedEvent(EVENT_B, 0), new TimedEvent(EVENT_A,
            0), new TimedEvent(EVENT_A, 1), new TimedEvent(EVENT_A, 2),
            new TimedEvent(
