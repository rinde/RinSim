        ...
        return Arrays.asList(new Object[][] //
                { { new Creator() {
                    ...
                    public RoadModel create(ForwardingRoadModelTest testClass) {
                        return new TestForwardingRoadModel(new PlaneRoadModel(
                                new Point(0, 0), new Point(10, 10), true, 10));
                    }
                } }, { new Creator() {
                    @Override
                    public RoadModel create(ForwardingRoadModelTest testClass) {
                        return new TestForwardingRoadModel(new GraphRoadModel(
                                testClass.createGraph()));
                    }
                } } });
