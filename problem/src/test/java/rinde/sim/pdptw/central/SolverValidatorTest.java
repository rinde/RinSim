...
public class SolverValidatorTest {
    ...
    public void validateNegativeRemainingTime() {
        final VehicleStateObject vs1 = new VehicleStateObject(vdto(), null, null, -1, null);
        final GlobalStateObject state =
    ...
    public void validateZeroSpeed() {
        ...
        final VehicleStateObject vs1 = new VehicleStateObject(dto1, null, null, 0, null);
        final GlobalStateObject state =
                new GlobalStateObject(null, ImmutableList.of(vs1), 0, null,
                        null, null);
        SolverValidator.validateInputs(state);
    ...
    public void validateParcelAvailableAndInInventory() {
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), null, ImmutableSet.of(p1), 0, null);
        final GlobalStateObject state =
    ...
    public void valiateInputsDestinationNotInContents() {
        final ImmutableSet<ParcelDTO> empty = ImmutableSet.of();
        final VehicleStateObject vs1 = new VehicleStateObject(vdto(), null, empty, 0, p1);
        final VehicleStateObject vs2 =
                new VehicleStateObject(vdto(), null, ImmutableSet.of(p2, p1), 0, null);
    ...
    public void validateCorrectInputs() {
        final ImmutableSet<ParcelDTO> empty = ImmutableSet.of();
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), null, ImmutableSet.of(p1), 0, p1);
        final VehicleStateObject vs2 =
                new VehicleStateObject(vdto(), null, ImmutableSet.of(p2), 0, null);
        final VehicleStateObject vs3 = new VehicleStateObject(vdto(), null, empty, 0, p3);
    ...
    public void validateInvalidNumberOfRoutes() {
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), new Point(0, 0), null, 0, null);
    ...
    public void validateParcelInTwoRoutes() {
        final ImmutableSet<ParcelDTO> empty = ImmutableSet.of();
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), new Point(0, 0), empty, 0, null);
        final VehicleStateObject vs2 =
                new VehicleStateObject(vdto(), new Point(0, 0), empty, 0, null);
        ...
        final ImmutableList<VehicleStateObject> vehicles = ImmutableList.of(vs1, vs2);
        final GlobalStateObject state =
    ...
    public void validateParcelTooManyTimes2() {
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), new Point(0, 0), ImmutableSet.of(p1),
                        0, null);
    ...
    public void validateOutputDestinationNotFirstInRoute() {
        final ImmutableSet<ParcelDTO> empty = ImmutableSet.of();
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), new Point(0, 0), empty, 0, p1);
    ...
    public void validateCorrectOutput() {
        ...
        final VehicleStateObject vs1 =
                new VehicleStateObject(vdto(), new Point(0, 0), empty, 0, null);
        final VehicleStateObject vs2 =
                new VehicleStateObject(vdto(), new Point(0, 0), ImmutableSet.of(p3),
                        0, null);
    ...
    public void testWrap() {
        ...
        final VehicleStateObject vs3 =
                new VehicleStateObject(vdto(), new Point(0, 0), empty, 0, p4);
        ...
        final ImmutableList<VehicleStateObject> vehicles =
