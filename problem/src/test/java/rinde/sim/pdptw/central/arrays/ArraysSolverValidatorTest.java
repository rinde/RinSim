...
public class ArraysSolverValidatorTest {
    ...
    public void validateInputsEmptyTravelTimeMatrix() {
        validateInputs(new int[][] {}, new int[] {}, new int[] {},
            new int[][] {}, new int[] {});
    }

    @Test(expected = IllegalArgumentException.class)
    public void validateInputsInvalidTravelTimeMatrix1() {
        validateInputs(new int[7][6], new int[] {}, new int[] {},
            new int[][] {}, new int[] {});
    }
    ...
    public void validateInvalidRouteLength() {
        validateOutputs(new SolutionObject(new int[3], new int[1], 0),
            new int[4][4], new int[4], new int[4], new int[][] {}, new int[4]);
    }
    ...
    public void validateDuplicatesInRouteStart() {
        validateOutputs(new SolutionObject(new int[] { 1, 1, 1, 1 },
                new int[1], 0), new int[4][4], new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateInvalidArrivalTimesFirst() {
        validateOutputs(new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] {
                1, -1, 0, 1 }, 0), new int[4][4], new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateInvalidArrivalTimes1() {
        validateOutputs(new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] {
                0, -1, 0, 1 }, 0), new int[4][4], new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateInvalidArrivalTimes2() {
        validateOutputs(new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] {
                0, 0, 0, 1 }, 0), travelTimes, new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateInvalidArrivalTimes3() {
        validateOutputs(new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] {
                0, 10, 0, 1 }, 0), travelTimes, new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateInvalidObjective() {
        validateOutputs(new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] {
                0, 10, 100, 108 }, 0), travelTimes, new int[4], new int[4],
            new int[][] {}, new int[4]);
    }
    ...
    public void validateMultiVehicleCorrect() {
        ...
        // tardiness: 1 + 60
        final SolutionObject sol1 =
                new SolutionObject(new int[] { 0, 1, 3 }, new int[] { 0, 10,
                        100 }, 73);
        // travel time for this route: 2 + 7
        // tardiness: 0 + 50
        final SolutionObject sol2 =
                new SolutionObject(new int[] { 0, 2, 3 },
                        new int[] { 0, 15, 90 }, 59);
    ...
    public void validateCorrect() {
        validateOutputs(
            new SolutionObject(new int[] { 0, 1, 2, 3 }, new int[] { 0, 10,
                    100, 108 }, 238), travelTimes, new int[4], new int[4],
            new int[][] {}, new int[4]).toString();
    }
    ...
    public void validateBig() {
        final int[][] travelTime =
                new int[][] {
                        { 0, 132, 233, 491, 644, 513, 284, 447, 435, 255, 140,
                                246 },
                        { 132, 0, 168, 380, 548, 508, 228, 399, 394, 301, 161,
                                163 },
                        { 233, 168, 0, 276, 414, 351, 61, 232, 227, 216, 127,
                                35 },
                        { 491, 380, 276, 0, 185, 439, 256, 263, 282, 463, 402,
                                250 },
                        { 644, 548, 414, 185, 0, 427, 373, 283, 307, 555, 534,
                                399 },
                        { 513, 508, 351, 439, 427, 0, 297, 177, 160, 280, 376,
                                373 },
                        { 284, 228, 61, 256, 373, 297, 0, 172, 167, 210, 162,
                                77 },
                        { 447, 399, 232, 263, 283, 177, 172, 0, 25, 286, 312,
                                242 },
                        { 435, 394, 227, 282, 307, 160, 167, 25, 0, 265, 298,
                                240 },
                        { 255, 301, 216, 463, 555, 280, 210, 286, 265, 0, 141,
                                250 },
                        { 140, 161, 127, 402, 534, 376, 162, 312, 298, 141, 0,
                                155 },
                        { 246, 163, 35, 250, 399, 373, 77, 242, 240, 250, 155,
                                0 } };
        final int[] releaseDates =
                { 0, 1245143, 1755843, 63643, 1330543, 711843, 1811843, 212643,
                        1453443, 0, 188143, 0 };
        final int[] dueDates =
        ...
        final SolutionObject sol =
                new SolutionObject(//
                        ...
                        new int[] { 0, 132, 4384, 3467, 2982, 1614, 4023, 2399,
                                2074, 1034, 593, 4719 }, //
                        1719);
    ...
    public void testWrapSingle() {
        final SingleVehicleArraysSolver s =
                wrap(new FakeSingleSolver(new SolutionObject(new int[] { 0, 1,
                        2, 3 }, new int[] { 0, 10, 100, 108 }, 238)));
    ...
    public void testWrapMulti() {
        ...
        final MultiVehicleArraysSolver s =
                wrap(new FakeMultiSolver(
                        new SolutionObject[] { new SolutionObject(new int[] {
                                0, 1, 2, 3 }, new int[] { 0, 10, 100, 108 },
                                228) }));
