...
public interface MultiVehicleArraysSolver {
     ...
     *            location. Value <code>verhicleTravelTimes[i][j]</code>
     *            indicates travel time from location of vehicle <code>i</code>
     *            to location <code>j</code>.
     * @param inventories <code>m x 2</code> matrix of vehicle and location
     *            pairs. Value at <code>inventories[i][0]</code> indicates the
     *            vehicle, <code>inventories[i][1]</code> indicates the
     *            location. Vehicles may occur more than once (i.e. they may
     *            have more than one location in their inventory). Only delivery
     *            locations can be in the inventory.
