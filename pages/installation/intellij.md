...
toc: false
permalink: installation_intellij.html
folder: installation
---
...
![New](pages/installation/images_intellij/1.png)

2. Choose ``Maven`` on the left and click ``Next >``<br/>
<img src="pages/installation/images_intellij/2.png" width="800">
...
Click ``Next``<br/>
<img src="pages/installation/images_intellij/3.png" width="800">

4. Choose a name and a location for your project.<br/>
Click ``Finish``<br/>
<img src="pages/installation/images_intellij/4.png" width="800">

5. In your ``Package Explorer`` you should see the following:<br/>
<img src="pages/installation/images_intellij/5.png" width="300"><br/>
...
<img src="pages/installation/images_intellij/6.png" width="800"><br/>
...
<img src="pages/installation/images_intellij/7.png" width="300">
