...
public class RandomWalkExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    schema
        .add(RandomWalkAgent.class, "/graphics/perspective/semi-truck-32.png");
    ...
    View.create(simulator)
        .with(new GraphRoadModelRenderer(), new FancyRenderer(),
            new RoadUserRenderer(schema, false)).setSpeedUp(5).show();
  }
  ...
  static class FancyRenderer implements ModelRenderer {
    ...
    public void renderDynamic(GC gc, ViewPort vp, long time) {
      ...
      final RGB[] rgbs = new RGB[] { new RGB(51, 0, 153), new RGB(0, 165, 43),
          new RGB(255, 125, 41) };
      int i = 0;
      for (final Entry<RoadUser, Point> entry : obs.entrySet()) {
