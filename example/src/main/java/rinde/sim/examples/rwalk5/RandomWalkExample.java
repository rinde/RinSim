...
public class RandomWalkExample {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.add(new ScenarioBuilder.MultipleEventGenerator<TimedEvent>(
				conv.hour(3).min(30).toTime(), 10, new ScenarioBuilder.EventTypeFunction(StandardType.ADD_TRUCK)));
		builder.add(new ScenarioBuilder.TimeSeries<TimedEvent>(
				conv.day(1).toTime(), conv.day(4).toTime(), conv.hour(12).min(17).toTime(), 
		...
		builder2.add(new ScenarioBuilder.MultipleEventGenerator<TimedEvent>(
				200000000, 140, new ScenarioBuilder.EventTypeFunction(StandardType.ADD_TRUCK)));
		builder2.add(new ScenarioBuilder.MultipleEventGenerator<TimedEvent>(
				200000, 30, new ScenarioBuilder.EventTypeFunction(StandardType.ADD_TRUCK)));
