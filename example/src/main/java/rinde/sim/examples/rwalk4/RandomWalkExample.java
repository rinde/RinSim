...
public class RandomWalkExample {
	...
	public static void main(String[] args) throws Exception {
		...
		Graph<LengthEdgeData> graph = DotGraphSerializer.getLengthGraphSerializer(new SelfCycleFilter()).read(MAP_DIR
				+ "leuven-simple.dot");
		...
		View.startGui(simulator, 4, new ObjectRenderer(roadModel, schema, false), new MessagingLayerRenderer(roadModel,
				schema2));
	}
}
