...
\begin{document}
%!TEX root = ../main.tex
\begin{tikzpicture}[scale=1,every node/.style={font=\scriptsize}, square/.style={regular polygon,regular polygon sides=4}]
\tikzset{>=latex}
...
\foreach \i in {1,...,\numTicks} {
  ...
  \node at (\tickWidth*.5+\i*\tickWidth-\tickWidth,5) [square,draw,fill=white] {$t_{\i}$};
